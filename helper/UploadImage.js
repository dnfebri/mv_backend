...
import { responseJson } from "./Respont.js"
...
export const uploadImage = (files, name) => {
  if (files === null || files.photo === null) return responseUpload(false, "File no upload");
...
export const uploadPost = (files, name) => {
  if (files === null || files.image === null) return responseUpload(false, "Image not upload");
